...
class VirshSandboxInternalStoreCommandExecRecord(BaseModel):
    """
    VirshSandboxInternalStoreCommandExecRecord
    """ # noqa: E501
    redacted: Optional[Dict[str, StrictStr]] = Field(default=None, description="placeholders for secrets redaction")
    timeout: Optional[TimeDuration] = None
    user: Optional[StrictStr] = None
    work_dir: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["redacted", "timeout", "user", "work_dir"]
