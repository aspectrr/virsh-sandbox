...
class VirshSandboxInternalStoreCommand(BaseModel):
    ...
    env_json: Optional[StrictStr] = Field(default=None, description="JSON-encoded env map")
    ...
    __properties: ClassVar[List[str]] = ["command", "ended_at", "env_json", "exit_code", "id", "metadata", "sandbox_id", "started_at", "stderr", "stdout"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "metadata": VirshSandboxInternalStoreCommandExecRecord.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
