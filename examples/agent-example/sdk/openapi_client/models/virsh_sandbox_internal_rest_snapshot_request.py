...
class VirshSandboxInternalRestSnapshotRequest(BaseModel):
    """
    VirshSandboxInternalRestSnapshotRequest
    """ # noqa: E501
    external: Optional[StrictBool] = Field(default=None, description="optional; default false (internal snapshot)")
    name: Optional[StrictStr] = Field(default=None, description="required")
    __properties: ClassVar[List[str]] = ["external", "name"]
