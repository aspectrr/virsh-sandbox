...
class VirshSandboxInternalRestRunCommandResponse(BaseModel):
    """
    VirshSandboxInternalRestRunCommandResponse
    """ # noqa: E501
    command: Optional[VirshSandboxInternalStoreCommand] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "command": VirshSandboxInternalStoreCommand.from_dict(obj["command"]) if obj.get("command") is not None else None
        })
        return _obj
