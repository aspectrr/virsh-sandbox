...
class VirshSandboxInternalRestStartSandboxRequest(BaseModel):
    """
    VirshSandboxInternalRestStartSandboxRequest
    """ # noqa: E501
    wait_for_ip: Optional[StrictBool] = Field(default=None, description="optional; default false")
    __properties: ClassVar[List[str]] = ["wait_for_ip"]
