...
class VirshSandboxInternalAnsibleJob(BaseModel):
    """
    ...
    status: Optional[VirshSandboxInternalAnsibleJobStatus] = None
    vm_name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["check", "id", "playbook", "status", "vm_name"]
