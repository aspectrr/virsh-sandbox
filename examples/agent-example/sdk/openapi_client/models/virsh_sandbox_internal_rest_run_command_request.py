...
class VirshSandboxInternalRestRunCommandRequest(BaseModel):
    """
    ...
    private_key_path: Optional[StrictStr] = Field(default=None, description="required; path on API host")
    timeout_sec: Optional[StrictInt] = Field(default=None, description="optional; default from service config")
    username: Optional[StrictStr] = Field(default=None, description="required")
    __properties: ClassVar[List[str]] = ["command", "env", "private_key_path", "timeout_sec", "username"]
