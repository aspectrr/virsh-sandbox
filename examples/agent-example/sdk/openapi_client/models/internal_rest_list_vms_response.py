...
class InternalRestListVMsResponse(BaseModel):
    """
    InternalRestListVMsResponse
    """ # noqa: E501
    vms: Optional[List[InternalRestVmInfo]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vms": [InternalRestVmInfo.from_dict(_item) for _item in obj["vms"]] if obj.get("vms") is not None else None
        })
        return _obj
