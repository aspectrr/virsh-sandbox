...
class VirshSandboxInternalStoreServiceChange(BaseModel):
    """
    VirshSandboxInternalStoreServiceChange
    """ # noqa: E501
    enabled: Optional[StrictBool] = None
    name: Optional[StrictStr] = None
    state: Optional[StrictStr] = Field(default=None, description="started|stopped|restarted|reloaded")
    __properties: ClassVar[List[str]] = ["enabled", "name", "state"]
