...
class AuditApi:
    ...
    async def get_audit_stats(
        ...
        _param = self._get_audit_stats_serialize(
    ...
    def _get_audit_stats_serialize(
        self,
        ...
        if "Audit" not in _header_params:
    ...
    async def query_audit_log(
        ...
        :param request: Audit query (optional)
        :type request: TmuxClientInternalTypesAuditQuery, optional
        :param _request_timeout: Timeout setting for this request. If one
                                 number is provided, it will be the total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._query_audit_log_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "TmuxClientInternalTypesAuditQueryResponse",
    ...
    async def query_audit_log_with_http_info(
        ...
        _headers: Optional[Dict[str, Any]] = None,
        _host_index: int = 0,
    ) -> ApiResponse[TmuxClientInternalTypesAuditQueryResponse]:
        """Query audit log
    ...
    def _query_audit_log_serialize(
        self,
        request: Optional[TmuxClientInternalTypesAuditQuery],
        _request_auth: Optional[Dict[str, Any]],
        _content_type: Optional[str],
        _headers: Optional[Dict[str, Any]],
        _host_index: int,
