...
class CommandApi:
    ...
    def get_allowed_commands(
        ...
        _param = self._get_allowed_commands_serialize(
    ...
    def _get_allowed_commands_serialize(
        self,
        ...
        if "Command" not in _header_params:
    ...
    def run_command(
        ...
        :param request: Run command request (required)
        :type request: TmuxClientInternalTypesRunCommandRequest
        :param _request_timeout: Timeout setting for this request. If one
                                 number is provided, it will be the total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._run_command_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "TmuxClientInternalTypesRunCommandResponse",
    ...
    def run_command_with_http_info(
        ...
        _headers: Optional[Dict[str, Any]] = None,
        _host_index: int = 0,
    ) -> ApiResponse[TmuxClientInternalTypesRunCommandResponse]:
        """Run command
