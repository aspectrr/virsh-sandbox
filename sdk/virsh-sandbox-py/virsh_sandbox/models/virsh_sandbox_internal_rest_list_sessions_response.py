...
class VirshSandboxInternalRestListSessionsResponse(BaseModel):
    """
    VirshSandboxInternalRestListSessionsResponse
    """  # noqa: E501

    sessions: Optional[List[VirshSandboxInternalRestSessionResponse]] = None
    total: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["sessions", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "sessions": [
                    VirshSandboxInternalRestSessionResponse.from_dict(_item)
