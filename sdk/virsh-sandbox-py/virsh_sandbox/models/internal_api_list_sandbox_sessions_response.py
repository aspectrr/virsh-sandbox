...
class InternalApiListSandboxSessionsResponse(BaseModel):
    """
    InternalApiListSandboxSessionsResponse
    """  # noqa: E501

    sessions: Optional[List[InternalApiSandboxSessionInfo]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "sessions": [
                    InternalApiSandboxSessionInfo.from_dict(_item)
