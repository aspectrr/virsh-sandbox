...
class VirshSandboxInternalRestListCertificatesResponse(BaseModel):
    ...
    certificates: Optional[List[VirshSandboxInternalRestCertificateResponse]] = None
    total: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["certificates", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "certificates": [
                    VirshSandboxInternalRestCertificateResponse.from_dict(_item)
                    for _item in obj["certificates"]
                ]
