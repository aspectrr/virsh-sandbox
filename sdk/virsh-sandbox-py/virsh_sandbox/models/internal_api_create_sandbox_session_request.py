...
class InternalApiCreateSandboxSessionRequest(BaseModel):
    """
    InternalApiCreateSandboxSessionRequest
    """  # noqa: E501

    sandbox_id: Optional[StrictStr] = Field(
        default=None, description="SandboxID is the ID of the sandbox to connect to"
    )
    session_name: Optional[StrictStr] = Field(
        default=None,
        description="SessionName is the optional tmux session name (auto-generated if empty)",
    )
    ttl_minutes: Optional[StrictInt] = Field(
        default=None,
        description="TTLMinutes is the certificate TTL in minutes (1-10, default 5)",
    )
    __properties: ClassVar[List[str]] = ["sandbox_id", "session_name", "ttl_minutes"]
