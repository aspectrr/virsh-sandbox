...
class VirshSandboxInternalRestRequestAccessRequest(BaseModel):
    """
    ...
    sandbox_id: Optional[StrictStr] = Field(
        default=None, description="SandboxID is the target sandbox."
    )
    ...
    user_id: Optional[StrictStr] = Field(
        default=None, description="UserID identifies the requesting user."
    )
