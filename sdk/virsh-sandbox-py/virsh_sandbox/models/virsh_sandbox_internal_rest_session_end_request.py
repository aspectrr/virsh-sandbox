...
class VirshSandboxInternalRestSessionEndRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["reason", "session_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"reason": obj.get("reason"), "session_id": obj.get("session_id")}
        )
        return _obj
